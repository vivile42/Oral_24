...
class EpochGroup():
    ...
    def add_epoch(self, file, g_num, idx):
        ...
        median_sys = self.find_sys_med(epoch)
        # needs to be defined here because median sys is subject dependant
        # self.sys_mask_all=[f'cardiac_phase=="sys" and R_stim_int < {median_sys}',
        # f'cardiac_phase=="sys" and R_stim_int > {median_sys}',
        # 'sys_mask==0 | cardiac_phase=="sys"',
        # 'sys_mask==1',
        # 'RSP_Phase_Completion<-0.5',
        # 'RSP_Phase_Completion>-0.5 and RSP_Phase_Completion<0',
        # 'RSP_Phase_Completion>0 and RSP_Phase_Completion<0.5',
        # 'RSP_Phase_Completion>0.5',
        # 'noh'

        self.sys_mask_all = ev_cs.sys_mask
    ...
    # miss toggles erp with miss included
    ...
    def save_evoked(self, cfa,miss=False):
        ...
        mne.write_evokeds(directory, self.group_evo_raw,overwrite=True)
